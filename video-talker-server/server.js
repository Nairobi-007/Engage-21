...
//   const accountSid='AC3c4c190576c6a96676ff6e7993e10e46';
//   const authToken='c8d7770306909ca5132120cfafa5fd49';
...
io.on('connection', (socket) => {
  ...
  //listeners related to message

   socket.on('sendingMessage',(data)=>{
     console.log('sending the message');
     console.log(data.MsgReciever);
     io.to(data.MsgReciever).emit('sendingMessage',{
